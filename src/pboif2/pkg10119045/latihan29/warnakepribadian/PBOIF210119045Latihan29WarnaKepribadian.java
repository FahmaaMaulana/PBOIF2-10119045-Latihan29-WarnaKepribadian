 ...
 */
package pboif2.pkg10119045.latihan29.warnakepribadian;
 ...
 */
public class PBOIF210119045Latihan29WarnaKepribadian {
    ...
    public static void kepribadian(String warna,String nama) {
        ...
        if (null != warna)switch (warna) {
            case "MERAH":
                ...
                System.out.println("3. Berani mengambil resiko setiap masalah ");
